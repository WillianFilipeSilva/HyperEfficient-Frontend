class CategoriasPage {
  ...
  async handleDelete(item) {
    if (window.Utils && typeof window.Utils.showModal === "function") {
      ...
      if (
        !confirm(`Tem certeza que deseja excluir a categoria "${item.nome}"?`)
      ) {
        return;
      }
              ...
              <tr class="hover:bg-white/5 transition-all duration-200" style="animation-delay: ${
                    ...
                    ${
                      ...
                      <div class="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div class="text-xs text-gray-400">Categoria • ID: ${
                            item.id
                          }</div>
                        </div>
                      </div>
                ...
                <td class="px-6 py-4">
                  <div class="flex items-center justify-center space-x-2">
                    <button 
                      onclick="categoriasPage.openEditModal(${JSON.stringify(
                        item
                      ).replace(/"/g, "&quot;")})"
                    ...
                    <button 
                      onclick="categoriasPage.handleDelete(${JSON.stringify(
                        item
                      ).replace(/"/g, "&quot;")})"
